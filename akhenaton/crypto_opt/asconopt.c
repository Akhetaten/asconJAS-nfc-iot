...
/* FIXED-SIZE ENCRYPTION (16 bytes) */
static void ascon_encrypt_16B(uint8_t *pt,
                              uint8_t *ct,
                              const uint8_t *key,
                              const uint8_t *nonce)
{
...
/*FIXED-SIZE DECRYPTION (16 bytes)*/
static void ascon_decrypt_16B(uint8_t *ct,
                              uint8_t *pt,
                              const uint8_t *key,
                              const uint8_t *nonce)
{
